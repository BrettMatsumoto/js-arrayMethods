...
/* slicing is both inclusive and exclusive on which elements it accepts
in the above example (1, 4) - 1 is included in the slice whereas 4 is excluded from the slice
*/
